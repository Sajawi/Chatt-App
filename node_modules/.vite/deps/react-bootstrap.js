import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-O5WBO4S7.js";
import {
  Button_default as Button_default2
} from "./chunk-Q2RVAF7V.js";
import {
  Button_default
...
var Card = React18.forwardRef(({
  ...
  return (0, import_jsx_runtime15.jsx)(Component2, {
    ...
    children: body ? (0, import_jsx_runtime15.jsx)(CardBody, {
      children
    }) : children
  });
});
...
function useDropdownMenu(options = {}) {
  const context6 = (0, import_react15.useContext)(DropdownContext_default);
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react16.default).createContext($704cf1d3b684cc5c$var$defaultContext);
function $704cf1d3b684cc5c$export$9f8ac96af4b1b2ae(props) {
  let cur = (0, import_react16.useContext)($704cf1d3b684cc5c$var$SSRContext);
  ...
  return (0, import_react16.default).createElement($704cf1d3b684cc5c$var$SSRContext.Provider, {
    value
  }, props.children);
}
...
function $704cf1d3b684cc5c$export$619500959fc48b26(defaultId) {
  let ctx = (0, import_react16.useContext)($704cf1d3b684cc5c$var$SSRContext);
  if (ctx === $704cf1d3b684cc5c$var$defaultContext && !$704cf1d3b684cc5c$var$canUseDOM)
    console.warn("When server rendering, you must wrap your application in an <SSRProvider> to ensure consistent ids are generated between the client and server.");
  return (0, import_react16.useMemo)(() => defaultId || `react-aria${ctx.prefix}-${++ctx.current}`, [
    defaultId
  ]);
}
...
var Switch = React49.forwardRef((props, ref) => (0, import_jsx_runtime45.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var NavLink = React61.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames40.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    var query = (0, import_react39.useMemo)(function() {
...
var Overlay = React72.forwardRef((props, outerRef) => {
  ...
  if (Transition) {
    ...
    child = (0, import_jsx_runtime71.jsx)(Transition, {
      in: props.show,
      appear: true,
      onExit,
      onExiting,
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react47.cloneElement)(children, triggerProps), (0, import_jsx_runtime75.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var ToastFade = React94.forwardRef((props, ref) => (0, import_jsx_runtime99.jsx)(Fade_default, {
  ...props,
  ref,
